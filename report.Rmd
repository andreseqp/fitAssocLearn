...
```{r boussard_interv,fig.cap='Bayesian estimation of parameters to the Boussard *et al* 2020 data-set. Light and dark grey bands correspond to the 50 and 90\\% credible interval'}
# pars2plot <- c("tau", "mu_alpha", "alphasT[1]", "alphasT[2]",
#                 "sigma_a")
# 
...
```{r, fig.cap='Bayesian estimation of parameters to the Boussard *et al* 2021 data set. Light and dark grey bands correspond to the 50 and 90\\% credible interval'}
...
## Fitting the model with 2 treatment effects and a colour effect
# Boussard [-@boussard_Link_2021] brain size *v.s.* age *v.s.* colour
...
```{r, fig.cap='Bayesian estimation of parameters to the Boussard *et al* 2021 data set. Light and dark grey bands correspond to the 50 and 90\\% credible interval'}
include_graphics("images/boussard2intervals_col.png")
```


```{r,fig.cap='Posterior predictive checks of the bayesian estimation. Points correspond to Boussard data-set. Light and dark coloured bands correspond to the 50 and 90\\% credible interval predicted by the model'}
include_graphics("images/boussard2_ppchecks_colour.png")
```

## Fitting the model with 2 treatment effects influencing the temperature parameter
# Boussard [-@boussard_Link_2021] brain size *v.s.* age 
...
boussard2_data %>% mutate(brainsize=factor(brainsize,labels=c("small","large")),
...
```{r, fig.cap='Bayesian estimation of parameters to the Boussard *et al* 2021 data set. Light and dark grey bands correspond to the 50 and 90\\% credible interval'}
include_graphics("images/boussard2intervals_tau.png")
```


```{r,fig.cap='Posterior predictive checks of the bayesian estimation. Points correspond to Boussard data-set. Light and dark coloured bands correspond to the 50 and 90\\% credible interval predicted by the model'}
include_graphics("images/boussard2_ppchecks_tau.png")
```

## Fitting the model with 2 treatment effects influencing the temperature parameter and random effects on the speed of learning
# Boussard [-@boussard_Link_2021] brain size *v.s.* age 
...
```{r, fig.cap='Bayesian estimation of parameters to the Boussard *et al* 2021 data set. Light and dark grey bands correspond to the 50 and 90\\% credible interval'}
include_graphics("images/boussard2intervals_tau_alpha.png")
```


```{r,fig.cap='Posterior predictive checks of the bayesian estimation. Points correspond to Boussard data-set. Light and dark coloured bands correspond to the 50 and 90\\% credible interval predicted by the model'}
include_graphics("images/boussard2_ppchecks_tau_alpha.png")
```


## Fitting the model with 2 treatment effects influencing the speed of learning  and random effects on the temperature parameter
# Boussard [-@boussard_Link_2021] brain size *v.s.* age 
...
```{r, fig.cap='Bayesian estimation of parameters to the Boussard *et al* 2021 data set. Light and dark grey bands correspond to the 50 and 90\\% credible interval'}
include_graphics("images/boussard2intervals_alpha_tau.png")
```


```{r,fig.cap='Posterior predictive checks of the bayesian estimation. Points correspond to Boussard data-set. Light and dark coloured bands correspond to the 50 and 90\\% credible interval predicted by the model'}
include_graphics("images/boussard2_ppchecks_alpha_tau.png")
```
